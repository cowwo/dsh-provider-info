		...
		services: [
			{
				...
				members: [
					...
					},
					{
						kind: 'method',
						name: 'balance',
						signature: 'async balance(request: { provider: string; baseURL?: string | null; apiKeyEnv?: string | null }): Promise<{ supported: boolean; family?: string | null; kind?: string | null; error?: string | null; membership?: string | null; balance?: object | null; windows?: object[] | null } | null>',
