...
export const TYPERT = {
	package: '@cowwo/dsh-provider-info',
	face: 'host',
	schemas: [],
	invocations: [
		{
			id: '@cowwo/dsh-provider-info#providerBadge/modelInfo',
			...
			parameters: [
				{
					...
					codec: {
						mode: 'strict',
						typeSymbol: '@cowwo/dsh-provider-info#providerBadge/modelInfo:request',
			...
			result: {
				mode: 'strict',
				typeSymbol: '@cowwo/dsh-provider-info#providerBadge/modelInfo:result',
